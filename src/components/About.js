            ...
            <div className="text-center">
              ...
              <ScrollAnimation>
                <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                  ...
                  WordPress, and SEO, currently advancing skills in the MERN stack
                  to create dynamic and scalable applications. Experienced in
                  building mobile apps with a focus on performance, usability, and
                  modern design.
                </p>
              </ScrollAnimation>
            </div>
