    ...
    <section className="font-poppins" id="Hero">
      <div className="max-w-7xl pl-5 ">
        <div className="flex gap-20 flex-col md:flex-row items-center  lg:h-[90vh] justify-between">
          <div className="w-full md:w-1/2 mt-10 md:mt-0 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0">
          ...
          <div className="md:w-1/2 relative flex justify-center items-end bg-black h-[60vh] lg:h-[90vh] ">
